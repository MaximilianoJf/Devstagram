...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
              ...
              @auth
                <nav class="flex gap-2 items-center">
                  <a href="{{route('posts.create')}}"
                    class="flex items-center gap-2 bg-white border rounded p-2 text-gray-600
                     roundedtext-sm uppercase font-bold cursor-pointer"
                  >
                  ...
                  {{--  Se neceita agregar la directiva @csrf mediante el metodo post --}}
        ...
        <main>
            <h2 class="font-black text-center text-2xl m-10">
                @yield('titulo')
            </h2>
            @yield('contenido')
        </main>
